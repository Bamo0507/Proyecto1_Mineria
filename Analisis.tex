...
\tightlist
\item
  ¿Sera que los departamentos mas frios tienden a tener una proporcion
  de divorcios mas bajos respecto al matrimonio?
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{matr\_depto\_cat\_mes }\OtherTok{\textless{}{-}}\NormalTok{ matrimonios\_depto }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(nivel\_geo }\SpecialCharTok{==} \StringTok{"departamento"}\NormalTok{, }\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(mes))}

\NormalTok{div\_depto\_cat\_mes }\OtherTok{\textless{}{-}}\NormalTok{ divorcios\_depto }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(nivel\_geo }\SpecialCharTok{==} \StringTok{"departamento"}\NormalTok{, }\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(mes))}
...
\NormalTok{matr\_depto\_cat}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## # A tibble: 308 x 5
##     anio nivel_geo    departamento    mes valor
##    <dbl> <chr>        <chr>         <dbl> <dbl>
##  1  2009 departamento alta verapaz     NA  4300
##  2  2009 departamento baja verapaz     NA  1334
##  3  2009 departamento chimaltenango    NA  3099
##  4  2009 departamento chiquimula       NA  1766
##  5  2009 departamento el progreso      NA   786
##  6  2009 departamento escuintla        NA  2859
##  7  2009 departamento guatemala        NA 11824
##  8  2009 departamento huehuetenango    NA  5276
##  9  2009 departamento izabal           NA  1276
## 10  2009 departamento jalapa           NA  1289
## # i 298 more rows
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{div\_depto\_cat}
\end{Highlighting}
\end{Shaded}
...
##     anio nivel_geo    departamento    mes valor
##    <dbl> <chr>        <chr>         <dbl> <dbl>
##  1  2009 departamento alta verapaz     NA   129
##  2  2009 departamento baja verapaz     NA    66
##  3  2009 departamento chimaltenango    NA    56
##  4  2009 departamento chiquimula       NA    91
##  5  2009 departamento el progreso      NA    47
##  6  2009 departamento escuintla        NA   160
##  7  2009 departamento guatemala        NA  1024
##  8  2009 departamento huehuetenango    NA    84
##  9  2009 departamento izabal           NA    86
## 10  2009 departamento jalapa           NA    79
## # i 298 more rows
\end{verbatim}
