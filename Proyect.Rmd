...
```{r}
# Tablas de frecuencia para departamentos (matrimonios)
...
# Tabla de frecuencia para departamentos (divorcios)
...
# Tabla de frecuencia para rangos de edad (matrimonios - mujeres)
...
# Tabla de frecuencia para rangos de edad (matrimonios - hombres)
